...
interface InvestorInsert {
  ...
  // Investment Focus (ACTUAL DB COLUMNS)
  stage?: string[];     // ['Pre-Seed', 'Seed', 'Series A']
  sectors?: string[];    // ['AI/ML', 'Fintech', 'Healthcare']
...
const REAL_VC_DATA: InvestorInsert[] = [
  ...
  },
  {
    ...
    stage: ['Seed', 'Series A', 'Series B'],
    sectors: ['Consumer', 'Enterprise', 'AI/ML'],
    geography: 'US',
    check_size_min: 1000000,
  ...
  // ANDREESSEN HOROWITZ (a16z)
  {
    ...
    sectors: ['AI/ML', 'Crypto', 'Enterprise', 'Consumer', 'Fintech', 'Bio'],
    geography: 'US, Global',
  ...
  // FOUNDERS FUND
  {
    ...
    stage: ['Seed', 'Series A', 'Series B'],
    sectors: ['AI/ML', 'Defense', 'Space', 'Biotech', 'Enterprise'],
    geography: 'US',
  ...
  // Y COMBINATOR
  {
    ...
    stage: ['Pre-Seed', 'Seed'],
    sectors: ['AI/ML', 'Developer Tools', 'B2B', 'Consumer', 'Fintech', 'Healthcare'],
    geography: 'US, Global',
  ...
  },
  {
    ...
    stage: ['Pre-Seed', 'Seed'],
    sectors: ['Consumer', 'B2B', 'Marketplace'],
    geography: 'US, Global',
    check_size_min: 125000,
    check_size_max: 500000,
  ...
  // FIRST ROUND CAPITAL
  {
    ...
    stage: ['Pre-Seed', 'Seed'],
    sectors: ['Consumer', 'Enterprise', 'Marketplace', 'SaaS'],
    geography: 'US',
    check_size_min: 500000,
  ...
  // BENCHMARK
  {
    ...
    stage: ['Seed', 'Series A'],
    sectors: ['Marketplace', 'Consumer', 'Enterprise'],
    geography: 'US',
  ...
  // ACCEL
  {
    ...
    stage: ['Seed', 'Series A', 'Series B'],
    sectors: ['Enterprise', 'SaaS', 'Fintech', 'Security'],
    geography: 'Europe, US',
    check_size_min: 1000000,
    check_size_max: 50000000,
  ...
  // LIGHTSPEED
  {
    ...
    stage: ['Seed', 'Series A'],
    sectors: ['Consumer', 'Fintech', 'Enterprise', 'Crypto'],
    geography: 'US',
    check_size_min: 1000000,
  ...
  // KHOSLA VENTURES
  {
    ...
    stage: ['Seed', 'Series A', 'Series B'],
    sectors: ['Climate', 'Healthcare', 'AI/ML', 'Enterprise'],
    geography: 'US',
    check_size_min: 1000000,
    check_size_max: 50000000,
  ...
  // GREYLOCK
  {
    ...
    stage: ['Seed', 'Series A', 'Series B'],
    sectors: ['Consumer', 'Enterprise', 'AI/ML', 'Marketplace'],
    geography: 'US',
    check_size_min: 2000000,
  ...
  // GENERAL CATALYST
  {
    ...
    stage: ['Seed', 'Series A', 'Series B', 'Growth'],
    sectors: ['Healthcare', 'Fintech', 'Enterprise', 'AI/ML'],
    geography: 'US',
    check_size_min: 2000000,
    check_size_max: 100000000,
  ...
  // NEA
  {
    ...
    stage: ['Seed', 'Series A', 'Series B', 'Growth'],
    sectors: ['Enterprise', 'Healthcare', 'Consumer'],
  ...
  // INSIGHT PARTNERS
  {
    ...
    sectors: ['Enterprise', 'SaaS', 'Data', 'Security'],
...
const ANGEL_DATA: InvestorInsert[] = [
  {
    ...
    stage: ['Pre-Seed', 'Seed'],
    sectors: ['AI/ML', 'Crypto', 'Consumer', 'Developer Tools'],
    geography: 'US, Global',
  ...
  },
  {
    ...
    stage: ['Seed', 'Series A'],
    sectors: ['AI/ML', 'Crypto', 'Enterprise', 'Biotech'],
    geography: 'US',
  ...
  },
  {
    ...
    sectors: ['Consumer', 'Creator Economy', 'Gaming', 'Web3'],
    geography: 'US',
    check_size_min: 100000,
