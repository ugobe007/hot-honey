-- ============================================================================
-- INVESTOR ENRICHMENT LIST (SIMPLIFIED - FIXED FOR TEXT[] ARRAYS)
-- ============================================================================
-- Simplified query that handles text[] arrays correctly
...
SELECT 
  ...
  CASE WHEN notable_investments IS NOT NULL AND jsonb_array_length(notable_investments::jsonb) > 0 THEN 'Yes' ELSE 'No' END AS has_notable,
