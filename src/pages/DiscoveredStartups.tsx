      ...
      <div className="max-w-[1800px] mx-auto p-4 space-y-4">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {startups.map((s) => (
                  <tr 
                    key={s.id} 
                    className={`border-t border-gray-700/50 hover:bg-gray-700/30 cursor-pointer ${selectedIds.has(s.id) ? 'bg-blue-500/10' : ''}`}
                    onClick={() => s.article_url && window.open(s.article_url, '_blank')}
                  >
        ...
        <div className="bg-gray-800/30 rounded-lg border border-gray-700/50 p-4">
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            ...
            <Link to="/admin/edit-startups" className="px-3 py-1.5 bg-cyan-600/20 border border-cyan-500/30 rounded text-cyan-400 hover:bg-cyan-600/30">✏️ Manual Uploads</Link>
