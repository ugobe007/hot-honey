      ...
      <div className="relative z-10 container mx-auto px-6 pt-28 pb-16">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-3 flex items-center justify-center gap-3">
            ...
            <span>
              <span className="block bg-gradient-to-r from-orange-400 via-red-500 to-amber-500 bg-clip-text text-transparent">Perfect Matches</span>
              <span className="block bg-gradient-to-r from-orange-400 via-red-500 to-amber-500 bg-clip-text text-transparent">... in Seconds</span>
            </span>
          </h1>
