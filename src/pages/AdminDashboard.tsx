    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={() => navigate('/login')} className="px-4 py-2 bg-cyan-700 text-white rounded-lg">Login</button>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 overflow-auto">
      ...
      <div className="max-w-[1800px] mx-auto p-4 space-y-4">
        ...
        <div className="grid grid-cols-4 gap-3 text-xs">
          {[
            { label: 'Total Startups', value: stats.totalStartups, color: 'text-cyan-400' },
        ...
        <div className="bg-gray-800/30 rounded-lg border border-gray-700/50 p-4">
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            ...
            <Link to="/benchmarks" className="px-3 py-1.5 bg-cyan-500/20 border border-cyan-500/30 rounded text-blue-400 hover:bg-cyan-500/30">📊 Benchmarks</Link>
          </div>
        </div>
      </div>
    </div>
