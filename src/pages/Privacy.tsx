    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-100 via-orange-50 to-yellow-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl mb-8">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-orange-600 mb-4">3. Information Sharing</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-orange-600 mb-4">4. Data Security</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-orange-600 mb-4">5. Your Rights</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-orange-600 mb-4">6. Cookies and Tracking</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-orange-600 mb-4">9. Contact Us</h2>
            ...
            <div className="bg-orange-50 rounded-2xl p-4">
              <p className="text-gray-700">
                ...
                <strong>Mail:</strong> Hot Money Honey, Inc.<br />
                [Your Address Here]
              </p>
            </div>
          </section>
