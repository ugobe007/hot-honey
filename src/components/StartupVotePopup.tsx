...
export default function StartupVotePopup({ isOpen, onClose, startup }: StartupVotePopupProps) {
  ...
  return (
    ...
    >
      <div 
        className="relative bg-gradient-to-br from-amber-50 to-orange-100 rounded-3xl p-8 max-w-md w-full border-2 border-orange-300 shadow-2xl shadow-orange-500/20"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Hot Money Accent */}
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-orange-500 to-amber-500 text-white text-xs font-bold px-4 py-1 rounded-full">
          🔥 HOT MONEY
        </div>
        ...
        {!voted ? (
          <>
            ...
            <div className="text-center mb-6 mt-2">
              ...
              <p className="text-orange-600 text-lg font-semibold">{startup.name}</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className="bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-bold py-5 px-6 rounded-2xl transition-all shadow-lg shadow-orange-500/30 hover:scale-105 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex flex-col items-center gap-2"
              >
